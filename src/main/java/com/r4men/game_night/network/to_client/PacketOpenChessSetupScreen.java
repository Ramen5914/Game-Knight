...
public record PacketOpenChessSetupScreen(String fen, String whitePlayer, String blackPlayer) implements IGameNightPacket {
    public static final Type<PacketOpenChessSetupScreen> TYPE = new Type<>(GameNight.id("open_chess_setup_screen"));
