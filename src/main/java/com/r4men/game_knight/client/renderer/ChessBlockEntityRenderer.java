package com.r4men.game_knight.client.renderer;

import com.mojang.blaze3d.vertex.PoseStack;
import com.r4men.game_knight.GameKnight;
import com.r4men.game_knight.block.entity.ChessBlockEntity;
import com.r4men.game_knight.client.renderer.ChessBlockEntityRenderer.ChessBlockEntityRenderState;
...
public record ChessBlockEntityRenderer(
    ...
    public static ChessBlockEntityRenderer create(BlockEntityRendererProvider.Context context) {
        Identifier blackBishopModel = GameKnight.id("chess/black_bishop");
        Identifier blackKingModel = GameKnight.id("chess/black_king");
        Identifier blackKnightModel = GameKnight.id("chess/black_knight");
        Identifier blackPawnModel = GameKnight.id("chess/black_pawn");
        Identifier blackQueenModel = GameKnight.id("chess/black_queen");
        Identifier blackRookModel = GameKnight.id("chess/black_rook");
        Identifier whiteBishopModel = GameKnight.id("chess/white_bishop");
        Identifier whiteKingModel = GameKnight.id("chess/white_king");
        Identifier whiteKnightModel = GameKnight.id("chess/white_knight");
        Identifier whitePawnModel = GameKnight.id("chess/white_pawn");
        Identifier whiteQueenModel = GameKnight.id("chess/white_queen");
        Identifier whiteRookModel = GameKnight.id("chess/white_rook");

        Identifier blackBishopCuboidModel = GameKnight.id("chess/black_bishop_cuboid");
        Identifier blackKingCuboidModel = GameKnight.id("chess/black_king_cuboid");
        Identifier blackKnightCuboidModel = GameKnight.id("chess/black_knight_cuboid");
        Identifier blackPawnCuboidModel = GameKnight.id("chess/black_pawn_cuboid");
        Identifier blackQueenCuboidModel = GameKnight.id("chess/black_queen_cuboid");
        Identifier blackRookCuboidModel = GameKnight.id("chess/black_rook_cuboid");
        Identifier whiteBishopCuboidModel = GameKnight.id("chess/white_bishop_cuboid");
        Identifier whiteKingCuboidModel = GameKnight.id("chess/white_king_cuboid");
        Identifier whiteKnightCuboidModel = GameKnight.id("chess/white_knight_cuboid");
        Identifier whitePawnCuboidModel = GameKnight.id("chess/white_pawn_cuboid");
        Identifier whiteQueenCuboidModel = GameKnight.id("chess/white_queen_cuboid");
        Identifier whiteRookCuboidModel = GameKnight.id("chess/white_rook_cuboid");
