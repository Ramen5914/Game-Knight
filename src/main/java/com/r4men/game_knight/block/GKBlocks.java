...
import com.r4men.game_knight.block.custom.ChessBlock;
import com.r4men.game_knight.block.custom.MonopolyBlock;
...
public class GKBlocks {
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(GameKnight.MOD_ID);
    ...
    private static <T extends Block> void registerBlockItem(String name, DeferredBlock<T> block) {
        GKItems.ITEMS.registerSimpleBlockItem(name, block, Item.Properties::useBlockDescriptionPrefix);
    }
